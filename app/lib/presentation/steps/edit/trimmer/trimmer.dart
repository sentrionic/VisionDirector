...
import 'package:vision_director/presentation/steps/edit/trimmer/file_formats.dart';
...
class Trimmer {
  ...
  Future<void> saveTrimmedVideo({
    ...
    final dateTime =
        DateFormat.yMMMd().addPattern('-').add_Hms().format(DateTime.now());

    // String _resultString;
    String outputPath;
    String? outputFormatString;
    final formattedDateTime = dateTime.replaceAll(' ', '');
    ...
    final path = await _createFolderInAppDocDir(
      videoFolderName,
      storageDir,
    ).whenComplete(
    ...
    final startPoint = Duration(milliseconds: startValue.toInt());
    final endPoint = Duration(milliseconds: endValue.toInt());
