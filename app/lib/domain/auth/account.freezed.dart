...
abstract class $AccountCopyWith<$Res> {
  ...
  $Res call({String id, Username username, EmailAddress email, Roles role});
}
...
class _$_Account extends _Account {
  ...
  @override
  String toString() {
    return 'Account(id: $id, username: $username, email: $email, role: $role)';
  }
...
abstract class _Account extends Account {
  const factory _Account(
      ...
      required final Roles role}) = _$_Account;
