...
mixin _$TaskListState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Task> tasks, List<Task> filteredTasks)
        loadSuccess,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(List<Task> tasks, List<Task> filteredTasks)? loadSuccess,
...
abstract class _LoadInProgress implements TaskListState {
...
abstract class _$$_LoadSuccessCopyWith<$Res> {
  ...
  $Res call({List<Task> tasks, List<Task> filteredTasks});
}
...
class _$_LoadSuccess implements _LoadSuccess {
  const _$_LoadSuccess(final List<Task> tasks, final List<Task> filteredTasks)
      : _tasks = tasks,
  ...
  @override
  String toString() {
    return 'TaskListState.loadSuccess(tasks: $tasks, filteredTasks: $filteredTasks)';
  }
...
abstract class _LoadSuccess implements TaskListState {
  const factory _LoadSuccess(
      final List<Task> tasks, final List<Task> filteredTasks) = _$_LoadSuccess;
